...
GooglePayButtonComponent.ɵfac = function GooglePayButtonComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || GooglePayButtonComponent)(ɵɵdirectiveInject(ElementRef));
};
...
GooglePayButtonModule.ɵfac = function GooglePayButtonModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || GooglePayButtonModule)();
};
